...
async function createAddress(address, address2, district, city_id, postal_code, phone){
    const insertQuery = 'INSERT INTO address(address, address2, district, city_id, postal_code, phone) VALUES($1, $2, $3, $4, $5, $6) RETURNING *';
...
async function updateAddress(address_id, address, address2, district){
    const updateQuery = 'UPDATE address SET address =$1, address2 =$2, district =$3 WHERE address_id =$4 RETURNING *';
